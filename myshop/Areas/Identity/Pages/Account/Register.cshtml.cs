...
namespace myshop.Areas.Identity.Pages.Account
{
    ...
    {
        //2-inject RoleManager<IdentityRole> _identityRole
        ...
        //hena add role in get register
        public async Task OnGetAsync(string returnUrl = null)
        {
            //add roles check if not exist.
            //when register add automatic this role.
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //add fields bt3t applicationuser
               user.Name = Input.Name;
                ...
                if (result.Succeeded) //y3ny user created 5las 
                {
        ...
        private ApplicationUser CreateUser() //sh3'len from applicationuser
        {
            try
            {
